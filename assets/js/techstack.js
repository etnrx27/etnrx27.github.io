...
const techStack = [
  ...
  },
  {
    ...
    langName: "C#",
    langDesc: "<li>C# is a general-purpose programming language that encompasses programming disciplines such as static typing, functional, generic and object-oriented</li>",
  },
  //{
  ...
  //},
  {
    ...
    langName: "Microsoft Excel",
    langDesc: "<li>Microsoft Excel is a spreadsheet program that features calculation or computation capabilities, graphing tools, pivot tables, and a macro programming language called Visual Basic for Applications</li>",
  },
  {
    langImage: "assets/images/techstack-page/SQL.png",
    langName: "SQL",
    langDesc: "<li>SQL is a langauge that is used in programming and designed for managing data held in relational database management systems</li>",
  },
];
